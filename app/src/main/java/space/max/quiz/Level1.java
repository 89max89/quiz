...
//        кнопка продолжить начало
        ...
        text_left.setText(array.texts1[num_left]);//достаем из массива текст
        ...
        img_right.setImageResource(array.images1[num_right]);//достаем из массива картинку
        text_right.setText(array.texts1[num_right]);//достаем из массива текст
